...
class Lawyer(models.Model):
    ...
    avocat_image = models.CharField(max_length=100,null=True,blank=False)
    social = models.CharField(max_length=100,null=True,blank=False)
    wilaya = models.CharField(max_length=30,null=True,blank=False)
